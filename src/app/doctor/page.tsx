...
import { EditModeContext } from "./layout";
...
import DoctorCalendarWidget from "@/components/widgets/DoctorCalendarWidget";
    ...
    const defaultWidgets: WidgetMeta[] = [
      {
        id: uuidv4(),
        zone: "left" as Zone,
        type: "DoctorBookingsWidget" as WidgetType,
        visible: true,
      },
      {
        id: uuidv4(),
      ...
      },
      {
        id: uuidv4(),
        zone: "left" as Zone,
        type: "PaymentWidget" as WidgetType,
        visible: true,
      },
      {
        id: uuidv4(),
      ...
      },
      {
        id: uuidv4(),
        zone: "right" as Zone,
        type: "DoctorCalendarWidget" as WidgetType,
        visible: true,
      },
          ...
          {availableWidgetTypes.map((type) => (
            <button
              ...
              onClick={() =>
                addWidget(
                  type,
                  type === "DoctorCalendarWidget" ? "right" : "left"
                )
              }
