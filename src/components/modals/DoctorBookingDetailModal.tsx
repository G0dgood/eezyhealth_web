...
interface DoctorBookingDetailModalProps {
  isOpen: boolean;
...
export default function DoctorBookingDetailModal({
  isOpen,
  booking,
  onClose,
}: DoctorBookingDetailModalProps) {
  if (!isOpen || !booking) {
    return null;
  }
      ...
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md mx-4">
        ...
        <div className="p-6 space-y-4">
          ...
          <div>
            ...
            <span className="text-sm text-gray-900">{booking.patientName}</span>
          </div>
